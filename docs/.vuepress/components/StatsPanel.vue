...
const items = ref([
  { icon: "📝", label: "文章", value: 18, desc: "篇原创内容", color: "#6366f1" },
  { icon: "📂", label: "分类", value: 9, desc: "个分类", color: "#8b5cf6" },
  { icon: "🏷️", label: "标签", value: 36, desc: "个标签", color: "#ec4899" },
  { icon: "📄", label: "页面", value: 122, desc: "页收录", color: "#14b8a6" },
