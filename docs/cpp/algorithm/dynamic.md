...
![爬到第 3 阶的方案数量](./static/climbing_stairs_example.png)
...
![方案数量递推关系](./static/climbing_stairs_state_transfer.png)
...
![爬楼梯对应递归树](./static/climbing_stairs_dfs_tree.png)
...
![记忆化搜索对应递归树](./static/climbing_stairs_dfs_memo_tree.png)
...
![爬楼梯的动态规划过程](./static/climbing_stairs_dp.png)
...
![爬到第 3 阶的最小代价](./static/min_cost_cs_example.png)
...
![爬楼梯最小代价的动态规划过程](./static/min_cost_cs_dp.png)
...
![带约束爬到第 3 阶的方案数量](./static/climbing_stairs_constraint_example.png)
...
![考虑约束下的递推关系](./static/climbing_stairs_constraint_state_transfer.png)
...
![最小路径和示例数据](./static/min_path_sum_example.png)
...
![状态定义与 dp 表](./static/min_path_sum_solution_state_definition.png)
...
![最优子结构与状态转移方程](./static/min_path_sum_solution_state_transition.png)
...
![边界条件与状态转移顺序](./static/min_path_sum_solution_initial_state.png)
...
![暴力搜索递归树](./static/min_path_sum_dfs.png)
...
![记忆化搜索递归树](./static/min_path_sum_dfs_mem.png)
...
![0-1 背包的示例数据](./static/knapsack_example.png)
...
![0-1 背包问题的暴力搜索递归树](./static/knapsack_dfs.png)
...
![0-1 背包问题的记忆化搜索递归树](./static/knapsack_dfs_mem.png)
...
![完全背包问题的示例数据](./static/unbounded_knapsack_example.png)
...
![零钱兑换问题的示例数据](./static/coin_change_example.png)
...
![零钱兑换问题 II 的示例数据](./static/coin_change_ii_example.png)
...
![编辑距离的示例数据](./static/edit_distance_example.png)
...
![基于决策树模型表示编辑距离问题](./static/edit_distance_decision_tree.png)
...
![编辑距离的状态转移](./static/edit_distance_state_transfer.png)
